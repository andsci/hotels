...
class BasicModel
{
    ...
    {
        return FrontendModel::getContainer()->get('database')->insert($table, $values);
    }
    ...
    {
        FrontendModel::getContainer()->get('database')->update($table, $values, $where, $whereValues);
    }
    ...
    {
        FrontendModel::getContainer()->get('database')->delete($table, $where, $whereValues);
    }
    ...
    {
        $translations = (array) FrontendModel::getContainer()->get('database')->getRecords(
            'SELECT *
             FROM '.$table.'
             WHERE '.$where, $whereValues);
